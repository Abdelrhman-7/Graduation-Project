    ...
    try {
      ...
      if (response.statusCode == 200) {
        return LogoutResponse(
          status: true,
          message: response.data?.toString() ?? 'Logout Successful',
        );
      }
      ...
      return LogoutResponse(
        status: false,
        message: e.response?.data?.toString() ?? _friendlyError(e),
      );
    } catch (e) {
      return LogoutResponse(status: false, message: e.toString());
    }
  }
